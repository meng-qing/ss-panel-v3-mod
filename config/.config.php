...
//
// !!! 修改此key为随机字符串确保网站安全 !!!
$System_Config['key'] = 'mengqing';
$System_Config['debug'] =  'true';  //  正式环境请确保为false
$System_Config['appName'] = 'Fast云加速';             //站点名称
$System_Config['baseUrl'] = 'https://fast-ssr.com';            // 站点地址
$System_Config['timeZone'] = 'PRC';        // PRC 天朝时间  UTC 格林时间
$System_Config['pwdMethod'] = 'sha256';       // 密码加密   可选 md5,sha256
$System_Config['salt'] = 'mengqing';               // 密码加密用，从旧版升级请留空
...
$System_Config['muKey'] = 'fastssr';
// 邮件
$System_Config['mailDriver'] = 'smtp';   // mailgun or smtp or sendgrid

// 用户签到设置
$System_Config['checkinMin'] = '2';       // 签到最少流量 单位MB
$System_Config['checkinMax'] = '10';       // 签到最多流量
...
$System_Config['db_host'] = '144.217.90.99';
$System_Config['db_database'] = 'fastssr';
$System_Config['db_username'] = 'fastssr';
$System_Config['db_password'] = 'LOVEME4869.';
...
# smtp
$System_Config['smtp_host'] = 'smtpdm.aliyun.com';
$System_Config['smtp_username'] = 'noreply@fast-ssr.com';
$System_Config['smtp_port'] = '465';
$System_Config['smtp_name'] = 'NOREPLY';
$System_Config['smtp_sender'] = 'noreply@fast-ssr.com';
$System_Config['smtp_passsword'] = 'LOVE48me69';
...
#测速周期/h
$System_Config['Speedtest_duration']='168';
...
#系统根域名 zhaoj.in 这样
$System_Config['wecenter_system_main_domain']='fast-ssr.com';
...
#Cloudxns
$System_Config['cloudxns_apikey']='bd0686abc86fb12aada69533492884ed';#自己去 cloudxns.net 申请
$System_Config['cloudxns_apisecret']='b964f73ea0a2a624';
$System_Config['cloudxns_domain']='fast-ssr.com';#你的域名



#自动备份设置
$System_Config['enable_auto_backup']='false';
$System_Config['auto_backup_email']='mengqing351998190@gmail.com';
$System_Config['auto_backup_webroot']='/data/wwwroot/fast-ssr.com';
$System_Config['auto_backup_passwd']='2695043718';


#跳转延时,ms
$System_Config['jump_delay']='30';
...
#注册时默认协议参数
$System_Config['reg_protocol_param']='4';

#注册时默认混淆方式
$System_Config['reg_obfs']='http_simple';

#注册时默认混淆参数
$System_Config['reg_obfs_param']='baidu.com';
...
$System_Config['geetest_id']='1c0b8de739ea8b19bdb6341d06826a0e';
$System_Config['geetest_key']='d6045197e2bdfff5926236b7f252c201';
...
$System_Config['enable_auto_clean_uncheck_days']='3';


#自动清理多少天没使用的0级用户
$System_Config['enable_auto_clean_unused']='true';
$System_Config['enable_auto_clean_unused_days']='7';
...
$System_Config['telegram_token']='309034708:AAHYNYN4goEvI8EpRR1FxNktOLUX62hjJX0';

#telegram bot,群组会话 ID,把机器人拉进群里之后跟他 /ping 一下即可得到。
$System_Config['telegram_chatid']='-1001102077423!';
...
$System_Config['tuling_apikey']='e017d36cb8cb402a870207b41d5c18e1';
$System_Config['tuling_apisecert']='f32e98cabb3f772f';

#Telegram 机器人账号
$System_Config['telegram_bot']='fast_ssr_bot';
...
$System_Config['telegram_request_token']='sjhueAMAndnenw2k2k1mmsJSJWMWiwiwthgousdfewh';
...
#alipay,spay
$System_Config['alipay_id']='14720300279126';
$System_Config['alipay_key']='1cabe1ac67faad3a5ad40a77ce95bf79';
