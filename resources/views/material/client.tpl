	 ...
	 <div class="page-banner page-banner-subpage banner-resources p-b-0">
        <div class="container">
            <div class="banner-slogan banner-slogan-hero text-center">
                <h1 class="slogan-title">Fast云加速 软件下载</h1>
                <p class="slogan-desc">Fast云加速服务在多平台均可使用，完美支持iOS10、安卓、Windows、macOS等操作系统，甚至可以在极路由（搭配SS插件）、Openwrt、支持梅林固件的路由器上面直接配置使用。</p>
            </div>
	...
	<div class="page-section section-center">
		<div class="container">
			<div class="blocks row">
			        				<div class="col-sm-4">
						<a class="panel panel-block panel-block-icon" href="https://itunes.apple.com/cn/app/wingy-smart-proxy-for-http/id1148026741">
							<div class="panel-icon"><img src="img/clients/wingy.jpg" hight="80" width="80"></div>
							<div class="panel-body">
								<h3 class="panel-title h4">Wingy for iOS(免费)</h3>
								<span class="link">App Store购买下载</span>
							</div>
						</a>
					</div>		
                                    <div class="col-sm-4">
						<a class="panel panel-block panel-block-icon" href="https://itunes.apple.com/cn/app/shadowrocket-for-shadowsocks/id932747118">
							<div class="panel-icon"><img src="img/clients/shadowrocket.svg"></div>
							<div class="panel-body">
								<h3 class="panel-title h4">Shadowrocket for iOS(推荐)</h3>
								<span class="link">App Store购买下载</span>
							</div>
						</a>
					</div>					
									...
									<div class="col-sm-4">
						<a class="panel panel-block panel-block-icon" href="https://itunes.apple.com/cn/app/surge-web-developer-tool-proxy/id1040100637">
							<div class="panel-icon"><img src="img/clients/surge.svg"></div>
							<div class="panel-body">
								<h3 class="panel-title h4">Surge for iOS(专业)</h3>
								<span class="link">App Store购买下载</span>
							</div>
						</a>
					</div>					
									<div class="col-sm-4">
						<a class="panel panel-block panel-block-icon" href="/ssr-download/ssr-win.7z">
							...
							<div class="panel-body">
								...
								<span class="link">立即下载</span>
									...
									<div class="col-sm-4">
						<a class="panel panel-block panel-block-icon" href="/ssr-download/ssr-android.apk">
							...
							<div class="panel-body">
								...
								<span class="link">立即下载</span>
									...
									<div class="col-sm-4">
						<a class="panel panel-block panel-block-icon" href="/ssr-download/ssr-mac.dmg">
