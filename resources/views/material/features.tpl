{include file='header.tpl'}
			...
			<div class="row">
				<div class="col-lg-4 col-md-5 col-sm-6">
					<div class="banner-slogan banner-slogan-hero">
						<h1 class="slogan-title">Fast云加速</h1>
						<h2 class="slogan-desc">Fast云加速服务拥有比业内平均速度快 5 倍的体验！为您的所有设备添加Fast云加速高速服务，立即开启无碍网络体验！</h2>
						<div class="actions"><a class="btn btn-lg btn-primary-light" href="/user/shop">购买Fast云加速<i class="zmdi zmdi-long-arrow-right"></i></a></div>
					</div>
				</div>
	...
	<div class="tabs-container">
		<ul class="nav nav-tabs">
            <li class="active"><a href="/features">云加速</a></li>
            <li><a href="/datacenter">数据中心</a></li>
            <li><a href="/panel">控制面板</a></li>
            <li><a href="/client">推荐软件</a></li>
		</ul>
    ...
    <div class="container">
        <div class="section-row row">
            ...
            <div class="col-md-5 col-sm-6 col-sm-pull-6">
                ...
                <p class="section-desc">Fast云加速提供分布全球的加速服务，使得您可以在任何地方开展国际贸易、收发Gmail及观看视频。位于西雅图、洛杉矶、达拉斯、亚特兰大、法兰克福、阿姆斯特丹、香港、日本、新加坡等九个城市。</p>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-xs-6">
            <div class="feature"><i class="icon icon-lg icon-infinity animate zoomIn"></i>
                <h3 class="h4">智能分流</h3>
                <p>连接点智能分流，多重负载均衡机制。在超过40个全球Fast云加速加速网络连接点间流动。</p>
            </div>
        </div>
        ...
        <div class="col-sm-4 col-xs-6">
            <div class="feature"><i class="icon icon-lg icon-settings animate zoomIn"></i>
                ...
                <p>所有Fast云加速服务器，均采用强劲Intel内核。不仅快速，更高效。</p>
            </div>
        </div>
        <div class="col-sm-4 col-xs-6">
...
<!-- /.page-section -->
    ...
    <div class="container">
        <div class="section-row row">
            <div class="col-sm-6 col-sm-push-6">
                <div class="section-image">
                    <div class="image image-active-in-sec"><span class="stop-watch image-shadow animate fadeInLeft"><span class="stop-watch-lines"></span><span class="stop-watch-hand animate rotateIn" data-animation-delay=".5s" data-animation-duration="5s"></span></span><i class="arrow-right zmdi zmdi-long-arrow-right animate fadeInLeft"></i><span class="server animate fadeInRight"></span></div>
                </div>
            </div>
            <div class="col-md-5 col-sm-6 col-sm-pull-6">
                <h2 class="section-title">一秒内开通，全天候售后</h2>
                <p class="section-desc">在您付款后，Fast云加速将在一秒内处理您的订单，并立即开通。快捷迅速。全天候售后支持，随时联系。</p>
            </div>
        </div>
        <div class="section-row row">
            <div class="col-sm-6">
                <div class="section-image">
                    <div class="image image-advanced-networking"><span class="globe image-shadow animate zoomIn"></span><span class="circle circle-lg circle-v4 animate zoomIn"><span>IPv4</span></span><span class="circle circle-lg circle-v6 animate zoomIn"><span>IPv6</span></span><span class="line-dashed-x line-v4 animate"></span><span class="line-dashed-x line-v6 animate"></span>
                    </div>
                </div>
            </div>
            <div class="col-md-5 col-sm-6 col-md-push-1">
                <h2 class="section-title">先进的网络连接</h2>
                <p class="section-desc">Fast云加速大多数机房，不仅可以在IPv4环境下使用，还支持与IPv6互通。在您的运营商部署IPv6之后，您即可使用更快捷的IPv6网络服务。</p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 col-sm-push-6">
                <div class="section-image">
                    <div class="image image-iso-snapshot"><span class="server image-shadow animate zoomIn"></span><span class="snapshot animate zoomIn" data-animation-delay=".5s"></span></div>
              </div>
              <!-- /.section-image -->
            </div>
            <div class="col-md-5 col-sm-6 col-sm-pull-6">
                <h2 class="section-title">更高权限</h2>
                <p class="section-desc">您可以自定义设置您的Fast云加速密码。此外，若您需要修改连接密码，仅需在后台简单操作即可。您完全掌握您的账户。</p>
            </div>
        </div>
    </div>
</div>
