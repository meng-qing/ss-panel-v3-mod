{include file='header.tpl'}
			...
			<div class="row">
				<div class="col-lg-4 col-md-5 col-sm-6">
					<div class="banner-slogan banner-slogan-hero">
						...
						<div class="actions"><a class="btn btn-lg btn-primary-light" href="/user/shop">立即购买云加速服务<i class="zmdi zmdi-long-arrow-right"></i></a></div>
					</div>
				</div>
	...
	<div class="tabs-container">
		<ul class="nav nav-tabs">
            ...
            <li class="active"><a href="/panel">控制面板</a></li>
	...
	<div class="page-section section-center">
		<div class="container"><br><br>
			...
			<p class="section-desc m-b-20">Fast云加速后台管理非常简单，不论是查看加速服务连接信息，还是查询流量使用情况，界面的依然那么简单易用，让人惊喜连连。</p><br><br><br><br><br><br><br><br><br>
	...
	<div class="page-section section-center section-blue section-control-panel">
		<div class="container">
			...
			<p class="section-desc m-b-40">Fast云加速后台管理界面，可方便查看流量使用情况。有关加速服务所需的所有信息，均可在后台一键查看。</p>
			<div class="row">
	...
	<div class="page-section section-center section-dark">
		<div class="container">
			...
			<p class="section-desc m-b-60">Fast云加速允许用户同时购买一种加速服务多次。您也可以同时购买应用于不同需求的服务。一键开通的服务，让您不必等待。</p>
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="panel panel-block">
						<table class="table table-responsive">
							...
							<tbody>
							<tr>
								<td><b>Fast云加速云加速 超值版-30G/月</b></td>
								<td>月付</td>
								<td>30 GB</td>
								<td>2016-04-21</td>
								<td>已过期</td>
							...
							<tr>
                                <td><b>Fast云加速云加速 游戏线路-50G/月</b></td>
                                <td>年付</td>
                                <td>50 GB</td>
                                <td>2015-12-28</td>
                                <td><span class="status status-success">可用</span></td>
